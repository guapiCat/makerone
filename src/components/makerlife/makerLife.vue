    ...
    <div>
        <div class="work-title" style="background: #F3F3F3;">
            ...
            <div class="classifylist">
                <!--<ul>-->
                    <!--<li @click="byClassify(item.value)" v-for="item,index in titletype"-->
                        <!--v-bind:class="{on:index==classifyClass}" class="title">{{item.desc}}-->
                    <!--</li>-->
                <!--</ul>-->
                <span v-bind:class="{clickClassify:index== classifyClass}"
                      @click="byClassify(index)" v-for="item,index in titletype" class="classifyDetail">{{item.desc}}</span>
            ...
            <div class="classifylist">
                <!--<ul>-->
                    <!--<li v-for="item,index in sorttitle" @click="bySort(index)" v-bind:class="{on:index==sortClass}"-->
                        <!--class=" title">{{item}}-->
                    <!--</li>-->
                <!--</ul>-->
                <span v-bind:class="{clickClassifyTwo:index== sortClass}"
                      @click="bySort(index)" v-for="item,index in sorttitle" class="classifyDetailTwo">{{item}}</span>
            </div>
        </div>
        <div class="workshow" style="width: 1200px;margin: 50px auto; ">
            <div class="center-box" v-for="item in makerlife ">
                ...
                <div class="conter-footer">
                    <span>点赞数：</span><img
                        src="../../../static/img/upvote.png"/><i>{{item.makerLive.liveThumbsUpNum}}</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <router-link :to="{name: 'lifedetail',params:{ workId: item.makerLive.id}}" class="see-details">
                    <button type="button" class="am-btn am-btn-primary am-radius">查看详情</button>
                </router-link>
            </div>
