<template>
    <div class="hello compon_center">
        <div class="myBigBorder">
            ...
            <section class="se_2">
                <p class="se_2_p"  v-if="this.getMakerWorkDisplay[11]"><span style="color: red">*</span>{{this.getMakerWorkDisplay[11].dictDesc}}</p>
              <div class="step" v-show="ishide">
              <div class="adNewMsg2">
                  ...
                  <div class="se_2_div1"   v-for="(item,index) in stepX">
                    ...
                    <div>
                      ...
                      <div class="am-form-group am-form-file" style="float:right; margin-right: 5%">
                        <button type="button" class="am-btn am-btn-danger am-btn-sm">
                          <i class="am-icon-cloud-upload"></i> 上传图片</button>
                        <input  v-on:change="update($event,index)"  style="margin-left: 20px;"   type="file" multiple accept="image/*">
                      </div>
                      <div  style="width: 122px;float: right;margin-top: 50px;">{{item.stepUrl}}</div>
                    </div>
                    <div>
                      <span class="se_2_sp bzms" >步骤描述</span><textarea v-model="stepX[index].content" class="bzmsTxt" name="" id="" cols="30"
                                                                       rows="4"></textarea>
  ...
  import {AXIOS} from "../../http-common";
    export default {
        ...
        methods:{
          ...
          next:function () {
             this.secondDisplay.push({key: this.getMakerWorkDisplay[8].dictValue, value:this.designThought})
            this.secondDisplay.push({key: this.getMakerWorkDisplay[9].dictValue, value:this.timeArrangement})
            this.secondDisplay.push({key:this.getMakerWorkDisplay[10].dictValue, value:this.equipment})
            this.secondDisplay.push({key:this.getMakerWorkDisplay[11].dictValue, value:''})
      ...
      created:function () {
        ...
        AXIOS.get('makerWorks/editMakerWork', {
          ...
          this.secondmsg=response.data
          this.designThought=this.secondmsg.makerWorkDisplays[7].content;
          this.timeArrangement=this.secondmsg.makerWorkDisplays[8].content;
          this.equipment=this.secondmsg.makerWorkDisplays[9].content;
          this.step=this.secondmsg.makerWorksSteps;
          if(this.secondmsg.makerWorksSteps.length>0){
